...
class TestAbs(unittest.TestCase):
    def test_regpage_one(self):
        try:
            link = "http://suninjuly.github.io/registration1.html"
            browser = webdriver.Chrome()
            browser.get(link)
            required_welcome_text = "Congratulations! You have successfully registered!"
            ...
            self.assertEqual(welcome_text, required_welcome_text, 'Text incorrect')
